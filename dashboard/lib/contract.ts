...
export const REGISTRY_ID =
  ...
  "CA5LRPUBK6HHK265QY53JVY565G5NDTODSNK2FZ5B3L5EUFARZFONIOD";

export const AIRSPACE_ID =
  process.env.NEXT_PUBLIC_AIRSPACE_ID ??
  "CA3XH77GYLTW3LTHISV56SXN4KWEQSMBTTSMIOXP3Q2CK56OFA3SRMUP";

export const CREDENTIALS_ID =
  process.env.NEXT_PUBLIC_CREDENTIALS_ID ??
  "CDZ4WBLWDDCSSMW4IMKTXKF6DVV24B6NR4TKVD5MLMT3OYJA3KLCBMWF";
